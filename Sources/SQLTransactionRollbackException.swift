...
open class SQLTransactionRollbackException: SQLTransientException {
    ...
    public convenience init( cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/sql/SQLTransactionRollbackException", classCache: &SQLTransactionRollbackException.SQLTransactionRollbackExceptionJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &SQLTransactionRollbackException.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/sql/SQLTransactionRollbackException", classCache: &SQLTransactionRollbackException.SQLTransactionRollbackExceptionJNIClass, methodSig: "()V", methodCache: &SQLTransactionRollbackException.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( reason: String? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: reason, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLTransactionRollbackException", classCache: &SQLTransactionRollbackException.SQLTransactionRollbackExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &SQLTransactionRollbackException.new_MethodID_6, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
