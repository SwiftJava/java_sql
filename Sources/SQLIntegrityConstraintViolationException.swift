...
open class SQLIntegrityConstraintViolationException: SQLNonTransientException {

    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        self.init( javaObject: nil )
        if !object.validDownCast( toJavaClass: "java.sql.SQLIntegrityConstraintViolationException", file, line ) {
            return nil
        }
    ...
    private static var SQLIntegrityConstraintViolationExceptionJNIClass: jclass?

    /// private static final long java.sql.SQLIntegrityConstraintViolationException.serialVersionUID
    ...
    /// public java.sql.SQLIntegrityConstraintViolationException(java.lang.String,java.lang.String,int,java.lang.Throwable)
    ...
    public convenience init( arg0: String?, arg1: String?, arg2: Int, arg3: java_lang.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/sql/SQLIntegrityConstraintViolationException", classCache: &SQLIntegrityConstraintViolationException.SQLIntegrityConstraintViolationExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Throwable;)V", methodCache: &SQLIntegrityConstraintViolationException.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( arg0: String? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLIntegrityConstraintViolationException", classCache: &SQLIntegrityConstraintViolationException.SQLIntegrityConstraintViolationExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &SQLIntegrityConstraintViolationException.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: String? ) {
        ...
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLIntegrityConstraintViolationException", classCache: &SQLIntegrityConstraintViolationException.SQLIntegrityConstraintViolationExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/String;)V", methodCache: &SQLIntegrityConstraintViolationException.new_MethodID_3, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: String?, arg2: Int ) {
        ...
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        __args[2] = JNIType.encode( value: arg2, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLIntegrityConstraintViolationException", classCache: &SQLIntegrityConstraintViolationException.SQLIntegrityConstraintViolationExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/String;I)V", methodCache: &SQLIntegrityConstraintViolationException.new_MethodID_4, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: java_lang.Throwable? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLIntegrityConstraintViolationException", classCache: &SQLIntegrityConstraintViolationException.SQLIntegrityConstraintViolationExceptionJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &SQLIntegrityConstraintViolationException.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: java_lang.Throwable? ) {
        ...
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLIntegrityConstraintViolationException", classCache: &SQLIntegrityConstraintViolationException.SQLIntegrityConstraintViolationExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &SQLIntegrityConstraintViolationException.new_MethodID_6, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: String?, arg1: String?, arg2: java_lang.Throwable? ) {
        ...
        __args[1] = JNIType.encode( value: arg1, locals: &__locals )
        __args[2] = JNIType.encode( value: arg2, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLIntegrityConstraintViolationException", classCache: &SQLIntegrityConstraintViolationException.SQLIntegrityConstraintViolationExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &SQLIntegrityConstraintViolationException.new_MethodID_7, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    /// public java.sql.SQLIntegrityConstraintViolationException()
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/sql/SQLIntegrityConstraintViolationException", classCache: &SQLIntegrityConstraintViolationException.SQLIntegrityConstraintViolationExceptionJNIClass, methodSig: "()V", methodCache: &SQLIntegrityConstraintViolationException.new_MethodID_8, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
