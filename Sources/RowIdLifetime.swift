...
open class RowIdLifetime: java_lang.Enum {
    ...
    open class func values() -> [RowIdLifetime]! {
        ...
        return JNIType.decode( type: [RowIdLifetime](), from: __return )
    }
    ...
    open class func valueOf( arg0: String? ) -> RowIdLifetime! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
    ...
    open class func valueOf( _ _arg0: String? ) -> RowIdLifetime! {
