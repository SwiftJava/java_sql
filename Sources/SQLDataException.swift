...
open class SQLDataException: SQLNonTransientException {
    ...
    public convenience init() {
        ...
        let __object = JNIMethod.NewObject( className: "java/sql/SQLDataException", classCache: &SQLDataException.SQLDataExceptionJNIClass, methodSig: "()V", methodCache: &SQLDataException.new_MethodID_1, args: &__args, locals: &__locals )
    ...
    public convenience init( reason: String?, SQLState: String?, vendorCode: Int, cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/sql/SQLDataException", classCache: &SQLDataException.SQLDataExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Throwable;)V", methodCache: &SQLDataException.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( reason: String?, SQLState: String?, cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/sql/SQLDataException", classCache: &SQLDataException.SQLDataExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &SQLDataException.new_MethodID_6, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( reason: String?, cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/sql/SQLDataException", classCache: &SQLDataException.SQLDataExceptionJNIClass, methodSig: "(Ljava/lang/String;Ljava/lang/Throwable;)V", methodCache: &SQLDataException.new_MethodID_7, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( cause: java_swift.Throwable? ) {
        ...
        let __object = JNIMethod.NewObject( className: "java/sql/SQLDataException", classCache: &SQLDataException.SQLDataExceptionJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &SQLDataException.new_MethodID_8, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
