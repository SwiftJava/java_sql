...
open class SQLFeatureNotSupportedException: SQLNonTransientException {
    ...
    public convenience init?( casting object: java_lang.JavaObject, _ file: StaticString = #file, _ line: Int = #line ) {
        ...
        if !object.validDownCast( toJavaClass: "java.sql.SQLFeatureNotSupportedException", file, line ) {
            return nil
        }
    ...
    public convenience init( arg0: String? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLFeatureNotSupportedException", classCache: &SQLFeatureNotSupportedException.SQLFeatureNotSupportedExceptionJNIClass, methodSig: "(Ljava/lang/String;)V", methodCache: &SQLFeatureNotSupportedException.new_MethodID_2, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init( arg0: java_lang.Throwable? ) {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
        let __object = JNIMethod.NewObject( className: "java/sql/SQLFeatureNotSupportedException", classCache: &SQLFeatureNotSupportedException.SQLFeatureNotSupportedExceptionJNIClass, methodSig: "(Ljava/lang/Throwable;)V", methodCache: &SQLFeatureNotSupportedException.new_MethodID_5, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
    ...
    public convenience init() {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __object = JNIMethod.NewObject( className: "java/sql/SQLFeatureNotSupportedException", classCache: &SQLFeatureNotSupportedException.SQLFeatureNotSupportedExceptionJNIClass, methodSig: "()V", methodCache: &SQLFeatureNotSupportedException.new_MethodID_8, args: &__args, locals: &__locals )
        self.init( javaObject: __object )
        JNI.DeleteLocalRef( __object )
    }
