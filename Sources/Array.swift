...
open class ArrayForward: JNIObjectForward, Array {
    ...
    open func getArray( map: java_swift.JavaMap? ) throws /* java.sql.SQLException */ -> java_swift.JavaObject! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getArray", methodSig: "(Ljava/util/Map;)Ljava/lang/Object;", methodCache: &ArrayForward.getArray_MethodID_13, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
    ...
    open func getArray( index: Int64, count: Int, map: java_swift.JavaMap? ) throws /* java.sql.SQLException */ -> java_swift.JavaObject! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getArray", methodSig: "(JILjava/util/Map;)Ljava/lang/Object;", methodCache: &ArrayForward.getArray_MethodID_15, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
    ...
    open func getResultSet( index: Int64, count: Int, map: java_swift.JavaMap? ) throws /* java.sql.SQLException */ -> ResultSet! {
        ...
        __args[1] = JNIType.toJava( value: count, locals: &__locals )
        __args[2] = JNIType.toJava( value: map, mapClass: "java/util/Map", locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getResultSet", methodSig: "(JILjava/util/Map;)Ljava/sql/ResultSet;", methodCache: &ArrayForward.getResultSet_MethodID_18, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
    ...
    open func getResultSet( map: java_swift.JavaMap? ) throws /* java.sql.SQLException */ -> ResultSet! {
        ...
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: map, mapClass: "java/util/Map", locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getResultSet", methodSig: "(Ljava/util/Map;)Ljava/sql/ResultSet;", methodCache: &ArrayForward.getResultSet_MethodID_20, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
    ...
    open func getResultSet() throws /* java.sql.SQLException */ -> ResultSet! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getResultSet", methodSig: "()Ljava/sql/ResultSet;", methodCache: &ArrayForward.getResultSet_MethodID_21, args: &__args, locals: &__locals )
        defer { JNI.DeleteLocalRef( __return ) }
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
