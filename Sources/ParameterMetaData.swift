...
public protocol ParameterMetaData: Wrapper {
    ...
    func getParameterType( arg0: Int ) throws /* java.sql.SQLException */ -> Int
    func getParameterType( _ _arg0: Int ) throws /* java.sql.SQLException */ -> Int

    /// public abstract java.lang.String java.sql.ParameterMetaData.getParameterTypeName(int) throws java.sql.SQLException

    func getParameterTypeName( arg0: Int ) throws /* java.sql.SQLException */ -> String!
    func getParameterTypeName( _ _arg0: Int ) throws /* java.sql.SQLException */ -> String!

    /// public abstract java.lang.String java.sql.ParameterMetaData.getParameterClassName(int) throws java.sql.SQLException

    func getParameterClassName( arg0: Int ) throws /* java.sql.SQLException */ -> String!
    func getParameterClassName( _ _arg0: Int ) throws /* java.sql.SQLException */ -> String!

    /// public abstract int java.sql.ParameterMetaData.getParameterMode(int) throws java.sql.SQLException

    func getParameterMode( arg0: Int ) throws /* java.sql.SQLException */ -> Int
    func getParameterMode( _ _arg0: Int ) throws /* java.sql.SQLException */ -> Int
...
open class ParameterMetaDataForward: WrapperForward, ParameterMetaData {
    ...
    open func getParameterType( arg0: Int ) throws /* java.sql.SQLException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func getParameterType( _ _arg0: Int ) throws /* java.sql.SQLException */ -> Int {
        return try getParameterType( arg0: _arg0 )
    }
    ...
    open func getParameterTypeName( arg0: Int ) throws /* java.sql.SQLException */ -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func getParameterTypeName( _ _arg0: Int ) throws /* java.sql.SQLException */ -> String! {
        return try getParameterTypeName( arg0: _arg0 )
    }
    ...
    open func getParameterClassName( arg0: Int ) throws /* java.sql.SQLException */ -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func getParameterClassName( _ _arg0: Int ) throws /* java.sql.SQLException */ -> String! {
        return try getParameterClassName( arg0: _arg0 )
    }
    ...
    open func getParameterMode( arg0: Int ) throws /* java.sql.SQLException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.encode( value: arg0, locals: &__locals )
    ...
    open func getParameterMode( _ _arg0: Int ) throws /* java.sql.SQLException */ -> Int {
        return try getParameterMode( arg0: _arg0 )
    }
