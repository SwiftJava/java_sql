...
public protocol SQLXML: JavaProtocol {
    ...
    func setString( arg0: String? ) throws /* java.sql.SQLException */
    func setString( _ _arg0: String? ) throws /* java.sql.SQLException */
...
open class SQLXMLForward: JNIObjectForward, SQLXML {
    ...
    open func getString() throws /* java.sql.SQLException */ -> String! {
        ...
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getString", methodSig: "()Ljava/lang/String;", methodCache: &SQLXMLForward.getString_MethodID_4, args: &__args, locals: &__locals )
    ...
    open func setString( arg0: String? ) throws /* java.sql.SQLException */ {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
    ...
    open func setString( _ _arg0: String? ) throws /* java.sql.SQLException */ {
        try setString( arg0: _arg0 )
    }
