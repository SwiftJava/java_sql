...
open class ResultSetMetaDataForward: WrapperForward, ResultSetMetaData {
    ...
    private static var isNullable_MethodID_23: jmethodID?

    open func isNullable( column: Int ) throws /* java.sql.SQLException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "isNullable", methodSig: "(I)I", methodCache: &ResultSetMetaDataForward.isNullable_MethodID_23, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
    ...
    private static var isSigned_MethodID_24: jmethodID?

    open func isSigned( column: Int ) throws /* java.sql.SQLException */ -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isSigned", methodSig: "(I)Z", methodCache: &ResultSetMetaDataForward.isSigned_MethodID_24, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Bool(), from: __return )
    ...
    private static var getPrecision_MethodID_25: jmethodID?

    open func getPrecision( column: Int ) throws /* java.sql.SQLException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getPrecision", methodSig: "(I)I", methodCache: &ResultSetMetaDataForward.getPrecision_MethodID_25, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int(), from: __return )
    ...
    private static var getScale_MethodID_26: jmethodID?

    open func getScale( column: Int ) throws /* java.sql.SQLException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getScale", methodSig: "(I)I", methodCache: &ResultSetMetaDataForward.getScale_MethodID_26, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int(), from: __return )
    ...
    private static var getColumnCount_MethodID_27: jmethodID?

    open func getColumnCount() throws /* java.sql.SQLException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getColumnCount", methodSig: "()I", methodCache: &ResultSetMetaDataForward.getColumnCount_MethodID_27, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int(), from: __return )
    ...
    private static var isAutoIncrement_MethodID_28: jmethodID?

    open func isAutoIncrement( column: Int ) throws /* java.sql.SQLException */ -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isAutoIncrement", methodSig: "(I)Z", methodCache: &ResultSetMetaDataForward.isAutoIncrement_MethodID_28, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Bool(), from: __return )
    ...
    private static var isCaseSensitive_MethodID_29: jmethodID?

    open func isCaseSensitive( column: Int ) throws /* java.sql.SQLException */ -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isCaseSensitive", methodSig: "(I)Z", methodCache: &ResultSetMetaDataForward.isCaseSensitive_MethodID_29, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Bool(), from: __return )
    ...
    private static var isSearchable_MethodID_30: jmethodID?

    open func isSearchable( column: Int ) throws /* java.sql.SQLException */ -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isSearchable", methodSig: "(I)Z", methodCache: &ResultSetMetaDataForward.isSearchable_MethodID_30, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Bool(), from: __return )
    ...
    private static var isCurrency_MethodID_31: jmethodID?

    open func isCurrency( column: Int ) throws /* java.sql.SQLException */ -> Bool {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallBooleanMethod( object: javaObject, methodName: "isCurrency", methodSig: "(I)Z", methodCache: &ResultSetMetaDataForward.isCurrency_MethodID_31, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Bool(), from: __return )
    ...
    private static var getColumnDisplaySize_MethodID_32: jmethodID?

    open func getColumnDisplaySize( column: Int ) throws /* java.sql.SQLException */ -> Int {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallIntMethod( object: javaObject, methodName: "getColumnDisplaySize", methodSig: "(I)I", methodCache: &ResultSetMetaDataForward.getColumnDisplaySize_MethodID_32, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: Int(), from: __return )
    ...
    private static var getColumnLabel_MethodID_33: jmethodID?

    open func getColumnLabel( column: Int ) throws /* java.sql.SQLException */ -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColumnLabel", methodSig: "(I)Ljava/lang/String;", methodCache: &ResultSetMetaDataForward.getColumnLabel_MethodID_33, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
    ...
    private static var getColumnName_MethodID_34: jmethodID?

    open func getColumnName( column: Int ) throws /* java.sql.SQLException */ -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getColumnName", methodSig: "(I)Ljava/lang/String;", methodCache: &ResultSetMetaDataForward.getColumnName_MethodID_34, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: String(), from: __return )
    ...
    private static var getSchemaName_MethodID_35: jmethodID?

    open func getSchemaName( column: Int ) throws /* java.sql.SQLException */ -> String! {
        var __args = [jvalue]( repeating: jvalue(), count: 1 )
        var __locals = [jobject]()
        __args[0] = JNIType.toJava( value: column, locals: &__locals )
        let __return = JNIMethod.CallObjectMethod( object: javaObject, methodName: "getSchemaName", methodSig: "(I)Ljava/lang/String;", methodCache: &ResultSetMetaDataForward.getSchemaName_MethodID_35, args: &__args, locals: &__locals )
        if let throwable = JNI.ExceptionCheck() {
            throw SQLException( javaObject: throwable )
        }
        return JNIType.toSwift( type: String(), from: __return )
